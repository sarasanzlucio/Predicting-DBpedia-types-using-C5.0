...
/*        -----------  */
{
  ...
  //Rprintf(" PROCESS QUEUE 1 \n");

  ProcessQueue(Fp, Lp, Cases);
  
  //Rprintf(" PROCESS QUEUE 2 \n");
...
/*   ------------  */
{
  ...
  for (; NWaiting > 0;) {
    ...
    //printf("PROCESS QUEUE NWAITING %d", NWaiting);
